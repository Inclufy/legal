...
We praten al jaren over wat we samen zouden kunnen doen. Dit is het moment om dat concreet te maken. Hieronder mijn voorstel voor jouw rol en aandeelhouderschap in de Marokkaanse JV.

Dit is **een uitwerking om over te denken**, geen take-it-or-leave-it. Je input is welkom op elk onderdeel. Sommige zaken zijn voor mij vast, sommige zijn onderhandelbaar — ik geef per onderdeel aan welke.

Lees rustig. We praten erover wanneer jij eraan toe bent.

---

## De opzet kort

We zetten een joint venture op voor inclusie-software in MENA. Basis Marokko, expansie naar de bredere regio en Afrika.
...
Totaal kapitaal-inleg in eerste 3 jaar: €575k cash + IP/brand van Inclufy. Geen externe banklening, geen tweede investeerder nodig in fase 1.
...
## Wat 20% kan opleveren — eerlijke projectie

Bij verwachte JV-trajectories:

| Scenario | Klanten jaar 5 | JV-waardering | Jouw equity (na verwatering) | Jouw cash bij exit |
|---|---|---|---|---|
| Pessimistisch — JV klein maar leeft | 25 | €5M | 18,5% | €925k |
| Realistisch — gestage groei | 50 | €9M | 15,9% | €1,4M |
| Sterk — succesvol | 100 | €23M | 13,5% | €3,1M |
| Home-run — exit aan strategic | 150+ | €40M+ | ~12% | €4,8M+ |

Daarbovenop: jouw secondary sale recht (Optie A) of dividend (Optie C) of extra equity (Optie B), afhankelijk van keuze.

Plus jouw €50k cash inleg blijft natuurlijk paper-waarde tot exit.

---

## Andere partijen — wat je moet weten

### Siham Loukile als CEO

Said, hier wil ik direct en eerlijk zijn:

Voor de operationele CEO-rol heb ik Siham gekozen. Haar profiel:

- **5 jaar account management bij Exact** (NL enterprise SaaS)
- **7 jaar strategic accounts bij Rackspace** (internationale enterprise-relaties, multi-jaar, multi-stakeholder)
- **18 maanden sabbatical in MA** na het verlies van haar man — actief herstel, mountain hiking, bewust gekozen tijd om zichzelf opnieuw op te bouwen
- **Klaar voor volgende carrière-stap** — ze heeft expliciet aangegeven dat ze deze rol wil
- **Drietalig** (Arabisch, Frans, Engels — Nederlands is haar moedertaal)
- **Woonachtig Marokko** sinds anderhalf jaar

Ik realiseer me dat ze mijn zus is. Dat is een feit. Ik kan dat niet wegpoetsen en wil het ook niet. Ik heb haar geselecteerd op profielmatch — niet op familieband.

**Wat ik van jou vraag op dit punt:** ben je het hiermee eens, heb je twijfels, zie je risico's? Voor ik dit verder uitwerk wil ik jouw oprechte input. Als je bezwaren hebt, wil ik die nu horen, niet later wanneer het moeilijker is om dingen aan te passen.

**Haar pakket:**
- 10% equity met 4-jaar vesting + 1-jaar cliff
- Salaris €70-100k (groeiend met JV)
- 12-15% bonus op KPI's
- Operationele autonomie, niet stemgerechtigd in board

### Khalid als investeerder

Khalid heeft een groot zorgbedrijf in NL en wil zijn verdiensten herinvesteren in een BV met internationale ambities. Hij is enthousiast over Inclufy's concept en wordt tegelijk **lead customer** in NL.

**Wat hij brengt:**
- €500k cash, getrancheerd over 3 jaar (€200k bij signing, €150k bij maand 12 en 24 op milestones)
- 10% equity bij €5M post-money
- Healthcare-sector expertise en validatie
- Patient capital — geen VC-druk
- 3-jaars klantcontract zijn zorgbedrijf bij Inclufy NL (apart, marktconform)
- 1 board-zetel

### Bennani als channel-partner

Gezien jullie samenwerkingsgeschiedenis is dit voor jou herkenbaar terrein. Vanwege zijn profiel (GM Techdesk + co-founder Ricoh Marokko/Afrika) heb ik hem niet als pure reseller gestructureerd maar als **strategic channel-partner**:

- 5% equity dag 1 — channel-contribution-in-kind (zijn Techdesk + Ricoh-netwerk)
- €25k cash inleg
- Earn-up naar 10% bij 25 klanten brought-by-Bennani
- Commissies op direct gebrachte deals (lager dan zuivere reseller, want hij heeft equity)
- Multi-country exclusiviteit MA + door Ricoh bediende Afrikaanse landen
- Reverse vesting 4 jaar

Hij weet dat jullie samenwerken in dit verband. Wat hij niet weet: zijn definitieve pakket. Daar komen we toe na ons gesprek.
...
- Inclufy BV: 2 zetels (mezelf + 1 nader te bepalen)
- Said (jij): 1 zetel als Chairman JV
- Khalid: 1 zetel
- Onafhankelijk lid: 1 zetel (samen aangewezen)

Siham is CEO, rapporteert aan board, niet stemgerechtigd.
...
| Budget jaarlijks, hires senior | 50%+1 |
| Nieuwe aandelen, strategie-shift, exit | 67% |
| Verkoop kern-IP, ontbinding | Unaniem |

### Said specifieke rechten

Beyond gewone aandeelhouder:
- Veto op vervanging CEO
- Veto op verandering eigen rol
- Veto op verwatering boven 18%
- Veto op verkoop aandelen aan partij waar je bezwaar tegen hebt
- Tag-along bij elke aandelenverkoop
- Drag-along vanaf 75%-meerderheid met fair-value floor

### Acceleratie

100% acceleratie van retention-vest bij:
- Change of control van JV
- Unfair termination jouw rol
- Materiële verandering van jouw aansprakelijkheden zonder akkoord
...
| Week | Stap |
|---|---|
| Week 1-2 | Jij leest, denkt, reageert |
| Week 3 | We praten persoonlijk — jouw input op alle onderdelen |
| Week 4 | Eventuele aanpassingen, bevestiging Siham haar pakket |
| Week 5-6 | Khalid term sheet — onderhandeling met hem |
| Week 7-8 | Bennani agreement |
| Maand 3 | Notarisatie NL + MA, statuten JV |
| Maand 4 | JV operationeel, eerste klant-pitches |

Geen druk om snel te tekenen. Wel: hoe sneller wij twee aligned zijn, hoe sneller de rest valt.
...
Dit voorstel is uitgewerkt op basis van wat ik denk dat eerlijk is voor jou, eerlijk voor mij, en realistisch voor wat we proberen te bouwen. Maar het is mijn versie van eerlijk. Jouw versie kan anders zijn.

We hebben 10 jaar gewerkt zonder ooit aandeelhouder van elkaar te zijn. Deze stap is groter dan een klant of project. Het is een commitment voor 5+ jaar samen door zware en mooie momenten.

Neem de tijd. Stel vragen. Vraag uitleg waar het onduidelijk is. Kom met een tegenvoorstel als delen niet passen. Ik verwacht geen direct ja — ik verwacht een eerlijke reactie.

En als je het uiteindelijk niet ziet zitten, ook dat is een geldig antwoord. Onze relatie is niet afhankelijk van deze deal.
